    ...
    <div className="relative min-h-screen bg-black grid-bg overflow-hidden flex flex-col pb-20">
      ...
      <section id="categories" className="relative z-10 max-w-6xl mx-auto px-6 py-16 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-8 items-start border-b border-neutral-900 pb-6 mb-12">
          ...
          <div className="lg:col-span-5 lg:text-right">
            <p className="text-xs md:text-sm text-neutral-500 leading-relaxed">
              Telusuri seluruh pustaka artikel kami tentang rekayasa perangkat lunak, desain antarmuka, simulasi fisika, dan sistem IoT pintar.
            </p>
          </div>
        </div>
            ...
            <Link href={`/blog/${post.slug}`} key={post.slug} className="block h-full">
              <Card className="p-4 h-full">
                <div className="flex flex-col h-full justify-between space-y-4">
                  <div className="flex flex-col space-y-3">
                    {post.coverImage && (
                      ...
                      <img
                        src={post.coverImage}
                        alt={post.title}
                        className="w-full h-40 object-cover rounded-lg border border-border-subtle opacity-75 group-hover:opacity-100 transition-all duration-300"
                      />
                    )}
                    <div className="flex flex-col space-y-2">
                      ...
                      <h3 className="text-base font-semibold text-white group-hover:text-neutral-300 transition-colors line-clamp-2 tracking-tight">
                        {post.title}
                      </h3>
                  ...
                  <div className="pt-3 border-t border-neutral-900/60 flex items-center justify-between mt-auto">
                    <span className="text-[11px] text-neutral-500">Oleh {post.author}</span>
                    <span className="text-[10px] font-semibold text-neutral-400 group-hover:text-white transition-colors flex items-center space-x-1">
                      <span>Baca Selengkapnya</span>
